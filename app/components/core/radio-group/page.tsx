  ...
  return (
    <div className="space-y-20 pb-24">
        ...
        <div className="p-12 rounded-sm border border-border bg-foreground/[0.02] relative overflow-hidden min-h-[400px] flex items-center justify-center transition-all duration-500 hover:bg-foreground/[0.03] hover:border-foreground/10">
          ...
          <div className="relative z-10 w-full max-w-sm space-y-8">
            <div className="space-y-2 px-1">
              ...
              <p className="text-[10px] font-mono text-foreground uppercase tracking-tighter">
            ...
            >
              <Card
                className={cn(
                  "p-4 flex items-center justify-between transition-all cursor-pointer border-border bg-background/40 hover:bg-foreground/[0.02]",
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="p-2 rounded-sm bg-background border border-border text-foreground">
                    <Flame size={14} />
                  </div>
                  <div>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="p-2 rounded-sm bg-background border border-border text-blue-500">
                    <Snowflake size={14} />
                  </div>
                  <div>
      ...
      <section className="space-y-12">
        ...
        <div className="space-y-16">
          <div className="space-y-6">
            ...
            <div className="p-10 rounded-sm border border-border bg-foreground/[0.01] flex flex-col gap-10 transition-all duration-500 hover:bg-foreground/[0.02] hover:border-foreground/10">
      ...
      <section className="space-y-8">
        ...
        <UsageBlock
          code={`<RadioGroup value={val} onValueChange={setVal}>\n  <div className="flex items-center gap-2">\n    <RadioGroupItem value="A" id="a" />\n    <Label htmlFor="a">Option_Alpha</Label>\n  </div>\n</RadioGroup>`}
        />
      </section>
    </div>
  );
